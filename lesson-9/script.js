		...
		window.addEventListener("scroll", function() {
			...
			eventListener = topButton.addEventListener("click", function(event) {
			// STEP 6b: Prevent the default action of the ancho
				event.preventDefault();
			// STEP 6c: Call the scrollToTop function
				scrollToTop();
			...
			pullQuote.forEach(function(element) {
				...
				clone.classList.remove('pullquote'); // "Garbage collect" the original pullquote class so that the original and cloned elements can have different styles
